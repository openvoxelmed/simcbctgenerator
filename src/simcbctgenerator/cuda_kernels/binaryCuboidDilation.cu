...
__global__ void binaryCuboidDilation(float *intVolMask, unsigned char *maskOut, int halfCuboidSizeX, int halfCuboidSizeY, int halfCuboidSizeZ, int sizeDimX, int sizeDimY, int sizeDimZ)
{
    ...
    maskOut[idx] = (int)summedValues > 0;
}
